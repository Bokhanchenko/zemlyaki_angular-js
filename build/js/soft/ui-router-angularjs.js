...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('angular'), require('@uirouter/core')) : typeof define === 'function' && define.amd ? define(['exports', 'angular', '@uirouter/core'], factory) : factory(global['@uirouter/angularjs'] = {}, global.angular, global['@uirouter/core']);
        ...
        if (core.isFunction(controllerInstance.uiOnParamsChanged)) {
            ...
            var paramsUpdated = function paramsUpdated($transition$) {
                ...
                if (changedToParams.length) {
                    ...
                    var newValues = core.filter(toParams, function (val$$1, key) {
