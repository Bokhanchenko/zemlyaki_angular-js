...
(function (global, factory) {
  (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('@uirouter/core'), require('angular')) : typeof define === 'function' && define.amd ? define(['exports', '@uirouter/core', 'angular'], factory) : factory(global['@uirouter/angularjs-resolve-service'] = {}, global['@uirouter/core'], global.angular);
})(undefined, function (exports, core, angular) {
  'use strict';
    ...
    resolve: function resolve(invocables, locals, parent) {
      ...
      var resolveData = function resolveData(parentLocals) {
        var rewrap = function rewrap(_locals) {
          return core.resolvablesBuilder({ resolve: core.mapObj(_locals, function (local) {
              return function () {
                return local;
              };
            }) });
